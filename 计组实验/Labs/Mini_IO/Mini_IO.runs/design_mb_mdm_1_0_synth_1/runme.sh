...
HD_PWD='D:/MYHUST/sophomore_year/second_semester/CCIT/Mini_IO/Mini_IO.runs/design_mb_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_mb_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_mb_mdm_1_0.tcl
