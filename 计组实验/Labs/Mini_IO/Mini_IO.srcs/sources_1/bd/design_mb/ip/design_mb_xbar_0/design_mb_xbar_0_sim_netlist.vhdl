...
architecture STRUCTURE of design_mb_xbar_0_axi_crossbar_v2_1_19_addr_arbiter_sasd is
  ...
  attribute SOFT_HLUTNM of \gen_arbiter.grant_rnw_i_2\ : label is "soft_lutpair21";
  ...
  attribute SOFT_HLUTNM of \m_atarget_hot[11]_i_4\ : label is "soft_lutpair22";
  ...
  attribute SOFT_HLUTNM of \m_atarget_hot[8]_i_5\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \m_atarget_hot[9]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \m_atarget_hot[9]_i_4\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \m_axi_bready[10]_INST_0\ : label is "soft_lutpair58";
  ...
  attribute SOFT_HLUTNM of \m_axi_bready[8]_INST_0\ : label is "soft_lutpair56";
  ...
  attribute SOFT_HLUTNM of \m_axi_wvalid[10]_INST_0\ : label is "soft_lutpair58";
  ...
  attribute SOFT_HLUTNM of \m_axi_wvalid[8]_INST_0\ : label is "soft_lutpair56";
  ...
  attribute SOFT_HLUTNM of \m_ready_d[2]_i_2\ : label is "soft_lutpair29";
...
\gen_arbiter.m_grant_hot_i[1]_i_16\: unisim.vcomponents.LUT5
    generic map(
      ...
      I4 => \gen_arbiter.m_grant_hot_i[1]_i_12_0\(1),
...
entity design_mb_xbar_0_axi_crossbar_v2_1_19_decerr_slave is
  port (
    ...
    \gen_arbiter.m_grant_hot_i_reg[1]_3\ : in STD_LOGIC;
    \gen_arbiter.m_grant_hot_i_reg[1]_4\ : in STD_LOGIC;
...
\gen_arbiter.m_grant_hot_i[1]_i_11\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFBAFF00FF00"
        ...
        port map (
      I0 => \gen_arbiter.m_grant_hot_i[1]_i_15_n_0\,
      I1 => \gen_arbiter.m_grant_hot_i[1]_i_6_0\,
      I2 => m_axi_awready(0),
      I3 => m_ready_d(2),
      I4 => \gen_arbiter.m_grant_hot_i[1]_i_6_1\,
...
\gen_arbiter.m_grant_hot_i[1]_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \gen_arbiter.m_grant_hot_i_reg[1]_3\,
      I4 => \gen_arbiter.m_grant_hot_i_reg[1]_4\,
      I5 => m_axi_awready(1),
      O => m_ready_d0(0)
    );
...
m_valid_i_i_6: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => \gen_arbiter.m_grant_hot_i[1]_i_11_0\(0),
      O => m_valid_i_i_6_n_0
    );
...
architecture STRUCTURE of design_mb_xbar_0_axi_register_slice_v2_1_18_axic_register_slice is
  ...
  attribute SOFT_HLUTNM of \m_payload_i[34]_i_8\ : label is "soft_lutpair64";
  ...
  attribute SOFT_HLUTNM of \m_ready_d[1]_i_3\ : label is "soft_lutpair59";
  ...
  attribute SOFT_HLUTNM of \skid_buffer[24]_i_2\ : label is "soft_lutpair62";
  attribute SOFT_HLUTNM of \skid_buffer[32]_i_2\ : label is "soft_lutpair61";
  attribute SOFT_HLUTNM of \skid_buffer[32]_i_5\ : label is "soft_lutpair61";
  attribute SOFT_HLUTNM of \skid_buffer[34]_i_3\ : label is "soft_lutpair63";
begin
  Q(34 downto 0) <= \^q\(34 downto 0);
  aa_rready <= \^aa_rready\;
...
addr_arbiter_inst: entity work.design_mb_xbar_0_axi_crossbar_v2_1_19_addr_arbiter_sasd
     port map (
      ...
      aclk => aclk,
      aresetn_d => aresetn_d,
      \aresetn_d_reg__0\(3) => addr_arbiter_inst_n_118,
      \aresetn_d_reg__0\(2) => addr_arbiter_inst_n_119,
      \aresetn_d_reg__0\(1) => addr_arbiter_inst_n_120,
      \aresetn_d_reg__0\(0) => addr_arbiter_inst_n_121,
      \gen_arbiter.any_grant_reg_0\(0) => reg_slice_r_n_38,
      \gen_arbiter.any_grant_reg_1\ => splitter_ar_n_5,
      \gen_arbiter.any_grant_reg_2\ => \gen_decerr.decerr_slave_inst_n_7\,
      \gen_arbiter.any_grant_reg_3\ => splitter_ar_n_3,
      \gen_arbiter.m_grant_hot_i[1]_i_12_0\(3 downto 0) => m_atarget_enc(3 downto 0),
      \gen_arbiter.m_grant_hot_i[1]_i_3_0\ => reg_slice_r_n_47,
      \gen_arbiter.m_grant_hot_i[1]_i_3_1\ => splitter_ar_n_4,
      \gen_arbiter.m_grant_hot_i[1]_i_3_2\ => reg_slice_r_n_46,
      \gen_arbiter.m_grant_hot_i[1]_i_3_3\ => reg_slice_r_n_41,
      \gen_arbiter.m_grant_hot_i[1]_i_6\ => reg_slice_r_n_39,
      \gen_arbiter.m_grant_hot_i[1]_i_6_0\ => reg_slice_r_n_44,
      \gen_arbiter.m_grant_hot_i[1]_i_6_1\ => reg_slice_r_n_43,
      \gen_arbiter.m_grant_hot_i[1]_i_6_2\ => reg_slice_r_n_40,
      ...
      \m_atarget_hot_reg[11]\ => addr_arbiter_inst_n_158,
      \m_atarget_hot_reg[11]_0\ => addr_arbiter_inst_n_159,
      ...
      m_axi_awready(8 downto 0) => m_axi_awready(10 downto 2),
      \m_axi_awready[9]\ => addr_arbiter_inst_n_113,
      m_axi_awready_2_sp_1 => addr_arbiter_inst_n_112,
      m_axi_awready_6_sp_1 => addr_arbiter_inst_n_111,
...
\gen_decerr.decerr_slave_inst\: entity work.design_mb_xbar_0_axi_crossbar_v2_1_19_decerr_slave
     port map (
      ...
      \gen_arbiter.m_grant_hot_i[1]_i_6_1\ => addr_arbiter_inst_n_111,
      \gen_arbiter.m_grant_hot_i_reg[1]\ => addr_arbiter_inst_n_37,
      \gen_arbiter.m_grant_hot_i_reg[1]_0\ => addr_arbiter_inst_n_81,
      \gen_arbiter.m_grant_hot_i_reg[1]_1\ => addr_arbiter_inst_n_93,
      \gen_arbiter.m_grant_hot_i_reg[1]_2\ => addr_arbiter_inst_n_113,
      \gen_arbiter.m_grant_hot_i_reg[1]_3\ => addr_arbiter_inst_n_112,
      \gen_arbiter.m_grant_hot_i_reg[1]_4\ => reg_slice_r_n_42,
      \gen_axilite.s_axi_arready_i_reg_0\ => \gen_decerr.decerr_slave_inst_n_7\,
      \gen_axilite.s_axi_awready_i_reg_0\ => addr_arbiter_inst_n_159,
      ...
      \s_axi_wready[1]_0\ => splitter_aw_n_7,
      \s_axi_wready[1]_1\ => splitter_aw_n_9,
      \s_axi_wready[1]_2\ => splitter_aw_n_5,
      \s_axi_wready[1]_3\ => splitter_aw_n_1
    );
...
entity design_mb_xbar_0_axi_crossbar_v2_1_19_axi_crossbar is
  ...
  attribute C_M_AXI_BASE_ADDR of design_mb_xbar_0_axi_crossbar_v2_1_19_axi_crossbar : entity is "704'";
  ...
  attribute C_NUM_MASTER_SLOTS of design_mb_xbar_0_axi_crossbar_v2_1_19_axi_crossbar : entity is 11;
  ...
  attribute P_M_AXI_SUPPORTS_READ of design_mb_xbar_0_axi_crossbar_v2_1_19_axi_crossbar : entity is "11'b11111111111";
  attribute P_M_AXI_SUPPORTS_WRITE : string;
  attribute P_M_AXI_SUPPORTS_WRITE of design_mb_xbar_0_axi_crossbar_v2_1_19_axi_crossbar : entity is "11'b11111111111";
...
architecture STRUCTURE of design_mb_xbar_0 is
  ...
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of inst : label is "704'";
  attribute C_M_AXI_READ_CONNECTIVITY : string;
